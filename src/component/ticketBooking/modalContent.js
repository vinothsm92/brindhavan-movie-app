...
function ModalContent({ ticketDetails, bookingHistory ,movie}) {
    debugger
   var op= movie.filter((e,i,arr)=>{debugger
                    ...
                    <div className="row mx-3">
                        <table className="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Gst</td>
                                    <td>{(invoiceSummary.totalSeatCount*invoiceSummary.ticketPrice)*invoiceSummary.gstRate/100}<i class="fa-solid fa-indian-rupee-sign"></i></td>
                                </tr>
                                <tr>
                                    <td>Internet Handling</td>
                                    <td>{invoiceSummary.totalSeatCount*invoiceSummary.serviceCharge}<i class="fa-solid fa-indian-rupee-sign"></i></td>
                                </tr>
                            </tbody>
                        </table>
